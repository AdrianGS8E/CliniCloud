...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2026 a las 17:33:01
...
(1, 1, 1, '2026-01-20 17:10:01', 5, '2026-01-20 17:10:01', 'ATENDIDO', 'ODONTOLOGIA'),
(2, 1, 1, '2026-01-20 17:11:47', 5, '2026-01-20 17:11:47', 'ATENDIDO', 'ODONTOLOGIA');
...
INSERT INTO `cuaderno_odontologia` (`idCuaOdontologia`, `idAtencion`, `tipoAtencion`, `jsonExamenGenral`, `jsonExamenBucoDental`, `jsonHabitosCostumbres`, `motivoConsulta`, `jsonRegistroClinico`) VALUES
(1, 2, 0, '{\"intervenido_quirurgicamente\":\"\",\"problemas_cardiacos\":\"\",\"diabetico\":\"No\",\"alergia_medicamentos\":\"\",\"cicatrizacion_normal\":\"\",\"problemas_coagulacion\":\"\",\"tratamiento_medico\":\"\",\"toma_medicamentos\":\"No\",\"embarazo\":\"\",\"fum\":\"\"}', '{\"higiene_dental\":\"Buena\",\"usa_cepillo_dental\":\"Sí\",\"frecuencia_cepillado\":\"\",\"usa_hilo_dental\":\"\"}', '{\"respirador_bucal\":\"\",\"usa_chupon\":\"\",\"fuma\":\"\",\"toma_alcohol\":\"\",\"masca_coca\":\"\"}', 'dolor de muela', '[]');
...
--
ALTER TABLE `cuaderno_odontologia`
  MODIFY `idCuaOdontologia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
