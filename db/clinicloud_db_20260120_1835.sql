...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2026 a las 23:35:09
...
INSERT INTO `atencion_clinica` (`idAtencion`, `idPaciente`, `idConsultorio`, `fechaAtencion`, `idUsuario`, `fechaRegistro`, `estadoAtencion`, `especialidad`, `tipoAtencion`) VALUES
(1, 1, 1, '2026-01-20 20:51:00', 5, '2026-01-20 20:51:02', 'ATENDIDO', 'ODONTOLOGIA', 'EXAMEN GENERAL');
...
INSERT INTO `cuaderno_odontologia` (`idCuaOdontologia`, `idAtencion`, `tipoAtencion`, `jsonInfoCuaderno`) VALUES
(1, 1, 'EXAMEN GENERAL', '{\"intervenido_quirurgicamente\":\"Sí\",\"problemas_cardiacos\":\"No\",\"diabetico\":\"No\",\"alergia_medicamentos\":\"No\",\"cicatrizacion_normal\":\"Sí\",\"problemas_coagulacion\":\"No\",\"tratamiento_medico\":\"No\",\"toma_medicamentos\":\"No\",\"embarazo\":\"No\",\"fum\":\"\"}');
